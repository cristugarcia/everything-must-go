...
export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-[calc(1rem+env(safe-area-inset-bottom))] right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#075e54] text-white shadow-xl transition hover:-translate-y-1 hover:bg-[#064e47] sm:bottom-5 sm:right-5 sm:h-auto sm:w-auto sm:gap-2 sm:px-5 sm:py-3.5"
    >
      <svg
        viewBox="0 0 32 32"
        aria-hidden="true"
